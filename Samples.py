...
# 11949128972 envia mensagem para o numero da célula
async def Proccess():
    await FirstMessage("5551999999999","Dimerson")
    await FirstMessage("5551999999999","Gustavo")
    await FirstMessage("5551999999999","Gustavo")
    time.sleep(60)
    ...
    await TipMessage("5551999999999")
    time.sleep(60)
    await LastMessage("5551999999999","Dimerson Daniel")
    await LastMessage("5551999999999","Gustavo")
    await LastMessage("5551999999999","Gustavo")
